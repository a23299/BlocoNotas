...
namespace BlocoNotas.Data.Migrations
{
    ...
    [Migration("20240422181735_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlocoNotas.Models.NoteTagged", b =>
                {
                    b.Property<int>("NoteTaggedId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NoteTaggedId"));

                    b.Property<int>("NoteFK")
                        .HasColumnType("int");

                    b.Property<int>("TagFK")
                        .HasColumnType("int");

                    b.HasKey("NoteTaggedId");

                    b.HasIndex("NoteFK");

                    b.HasIndex("TagFK");

                    b.ToTable("NoteTagged");
                });
            ...
            modelBuilder.Entity("BlocoNotas.Models.NoteTagged", b =>
                {
                    b.HasOne("BlocoNotas.Models.Note", "Note")
                        .WithMany("ListaNotasTagged")
                        .HasForeignKey("NoteFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
